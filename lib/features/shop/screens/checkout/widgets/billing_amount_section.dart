      ...
      children: [
        Row(
          children: [
            ...
            Text('\$325',style: Theme.of(context).textTheme.bodyMedium,),
          ],
        ),
        ...
        Row(
          children: [
            ...
            Text('\$325',style: Theme.of(context).textTheme.labelLarge,),
          ],
        ),
        SizedBox(height: USizes.spaceBtwItems/2,),
        Row(
        ...
        Row(
          children: [
            ...
            Text('\$325',style: Theme.of(context).textTheme.titleMedium,),
          ],
        ),
      ],
    );
